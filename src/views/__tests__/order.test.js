...
import display from '../order.js';

describe('Order', () => {
  it ('General Case', () => {
    const result = `<div style="height: 50px"></div>
  <form>
    <div class="container" style="max-width: 600px">
      ...
      <button type="submit" class="submitfrombtn btn btn-primary">Submit</button>
    </div>
  </form>`;
    expect(display()).toEqual(result);
  });
});
